...
file_list = glob.glob("/home/pi/music/blind_test/Ensemble/*.mp3")
for filepath in file_list:
...
class BlindMaster(forms.Form):
    ...
    remove_point = forms.ChoiceField(choices=team_choice, widget=forms.RadioSelect(choices=team_choice), required=False)
